...
- [ ] Refactor older documents for clarity and format
- [ ] Write or append metadata headers for each document
- [ ] Add code blocks, callouts, tables, and citations where needed
- [ ] Use consistent style and tone throughout
...
- [ ] Ensure code syntax highlighting (e.g., with Fira Code)
